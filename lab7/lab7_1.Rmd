...
```{r}
?msleep #only helpful with loaded in data
```
...
## GOING TO BE ON EXAM `n_distinct()` is a very handy way of cleanly presenting the number of distinct observations. Here we show the number of distinct genera over 100 in body weight.  
